...
/* NetPak64 vendor prelude: IDO 5.3 (C89) compatibility. */
#ifndef __GNUC__
    #define inline /* C89: no inline keyword; these are tiny wrappers anyway */
#endif
/* mk64 links bzero, not memset */
#undef OS_USEC_TO_CYCLES /* os.h's version doesn't reach IDO here; 46.875MHz counter */
#define OS_USEC_TO_CYCLES(u) (((u64)(u) * 46875LL) / 1000LL)
#ifndef ALIGN
    #define ALIGN(value, align) (((value) + ((align) - 1)) & ~((align) - 1))
#endif
/* NetPak64 vendor note: mk64's ultra64 headers do not define TRUE/FALSE. */
#ifndef TRUE
    #define TRUE 1
#endif
#ifndef FALSE
