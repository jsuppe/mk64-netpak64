/* NetPak64 vendor note: 'unsigned long' -> 'unsigned int' to match mk64's
 * 32-bit u32 typedef (GCC treats them as distinct types even at equal width). */
#ifndef UNFL_USB_H
#define UNFL_USB_H
    ...
    *********************************/
    ...
    extern unsigned int usb_poll(void);
